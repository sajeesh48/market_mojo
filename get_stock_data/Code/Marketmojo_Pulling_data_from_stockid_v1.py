...
df1.to_csv(f'D:\\StockMarket\\Program\\Marketmojo_Pulling_data_from_stockid\\Output\\stock_id_404_error_{date_str}.csv', index=False, header=True)
...
my_df.to_csv(f'D:\\StockMarket\\Program\\Marketmojo_Pulling_data_from_stockid\\Output\\stock_data_found_{date_str}.csv', index=False, header=True)
my_df_nf.to_csv(f'D:\\StockMarket\\Program\\Marketmojo_Pulling_data_from_stockid\\Output\\stock_data_not_found_{date_str}.csv', index=False, header=True)
